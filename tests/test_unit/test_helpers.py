# Copyright (c) 2018, Novo Nordisk Foundation Center for Biosustainability, Technical University Denmark.
#
...
import sanger_sequencing.helpers as helpers
...
def test_show_versions(capsys):
    ...
    assert any(l.startswith("sanger-sequencing") for l in lines[9:])
